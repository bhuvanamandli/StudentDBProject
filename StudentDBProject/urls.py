...
urlpatterns = [
    ...
    path('studentinputverifyview/', views.studentinputverifyview),
    path('studentinputview2/', views.studentinputview2),
    path('studentloginpageview/', views.studentloginpageview),
    path('studentloginverifypageview/', views.studentloginverifypageview),
